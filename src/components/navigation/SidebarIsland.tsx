...
const SidebarContent = () => {
    ...
    return (
        <nav className="flex-1 overflow-y-auto py-4 px-3 space-y-1" aria-label="Sidebar">
            ...
            {/* 4. Locations/Offices */}
            <div className="pt-2">
                <a href="/locations/" className="flex items-center px-3 py-2 text-sm font-medium rounded-md text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800 transition-colors">
                    <svg className="w-5 h-5 mr-3 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
