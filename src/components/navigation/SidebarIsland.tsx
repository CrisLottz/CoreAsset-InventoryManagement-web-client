            ...
            <div className="pt-2">
                ...
                {isSettingsOpen && (
                    <div className="mt-1 space-y-1 pl-10">
                        ...
                        <a href="#" className="block px-3 py-2 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800">General Configuration</a>
                    </div>
                )}
            </div>
        </nav>
