            ...
            <div className="flex flex-col md:flex-row gap-4 justify-between bg-white dark:bg-surface-elevated p-4 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
                ...
                <div className="flex w-full md:w-auto">
                    ...
                    >
                        ...
                        {/* Iteración dinámica pura, sin quemar valores */}
                        {structure.fields.map((f: any) => {
                            // Enrutamiento físico para llaves foráneas
                            const backendKey = f.field_type === 'LOCATION' ? 'location' : 
                                               f.field_type === 'EMPLOYEE' ? 'assigned_to' : f.name;
                ...
                <div className="flex flex-wrap items-center gap-3">
                    <div className="flex items-center gap-2">
                        ...
                        <select 
                            ...
                            className="py-2 pl-3 pr-8 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-surface-base text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-1 focus:ring-primary-500 transition-colors"
                        >
                    ...
                    <button 
                        onClick={() => alert("Dnd-Kit View Manager Modal will open here.")}
                        className="flex items-center gap-2 px-4 py-2 text-sm font-bold text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 dark:bg-surface-elevated dark:text-gray-200 dark:border-gray-600 dark:hover:bg-gray-800 transition-colors shadow-sm"
                    >
